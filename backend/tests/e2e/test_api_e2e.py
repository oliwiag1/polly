...
class TestSubmitResponseE2E:
    ...
    def test_submit_response_success(self, client):
        ...
        answer_data = {
            "answers": [{"question_id": "q1", "value": "John Doe"}],
    ...
    def test_submit_response_missing_required(self, client):
        ...
        answer_data = {
            "answers": [{"question_id": "q2", "value": "Optional answer"}],
        }
    ...
    def test_submit_response_survey_not_found(self, client):
        ...
        fake_id = str(uuid4())
        answer_data = {
            "answers": [{"question_id": "q1", "value": "test"}],
        }
    ...
    def test_submit_anonymous_response(self, client):
        ...
        answer_data = {
            "answers": [{"question_id": "q1", "value": "Anonymous answer"}],
        }
...
class TestCompleteWorkflowE2E:
    ...
    def test_multiple_surveys_workflow(self, client):
        ...
        for survey in surveys:
            for j in range(2):
                answer_data = {
                    "answers": [{"question_id": "q1", "value": f"Answer {j}"}],
                }
