...
class TestDatabaseServiceIntegration:
    ...
    def test_service_uses_database(self, survey_service, database, sample_survey_create):
...
class TestConfigServiceIntegration:
    ...
    def test_config_change_affects_new_surveys(
        ...
        original_url = survey1.links.survey_url
...
class TestFullWorkflowIntegration:
    ...
    def test_multiple_surveys_isolation(
        self, survey_service, sample_survey_create
    ):
